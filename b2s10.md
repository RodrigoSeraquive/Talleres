...
object Problema1 extends App {
  ...
  val listaNotas = Var(List(10))

  val sumaNotas = Signal {
    listaNotas.value.sum
  }

  sumaNotas.observe { total =>
    println(s"Suma actual = $total")
  }

  listaNotas.set(listaNotas.now :+ 10)
  listaNotas.set(listaNotas.now :+ 20)
}


```
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/745a9f87-47a2-44b8-99fa-f915ed2cf273" />
...
```
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/81de25ef-2395-4db3-a4d2-8f26ebbf0290" />
